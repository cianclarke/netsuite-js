...
Search.MessageSearchBasic = require('./messageSearchBasic');
Search.SupportCaseSearchBasic = require('./supportCaseSearchBasic');
Search.SupportCaseSearchAdvanced = require('./supportCaseSearchAdvanced');
